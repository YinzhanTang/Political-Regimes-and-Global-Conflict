...
p4v_conflict %>%
  ...
  scale_x_continuous(breaks = c(-10, -5, 0 , 5, 10),
                   labels = c("Highly Autocrative", "Autocrative", "Neutral", "Democratic" ,"Highly Democratic")) +  
  scale_fill_discrete("Propotion of Countries with", 
                           label = c("0~3 Bordering Countries",
                                     "3~5 Bordering Countries" ,
                                      ">5 Border Countries")) +
...
There are usually many other reasons behind conflicts, thus further examination is needed to identify the individual impact of political regimes. In this graph, I chose the number of natural border countries as a reference since this factor is usually not correlated with the political regimes of countries. 

This graph similary shows that autocrative states involved in much more interstate conflicts compared to democratic states. Although highly democratic countries as a whole also have a very high total conflict magnitudes, the majority of these conflicts happened in countries with 3 or more border countries, while a large amounts of conflicts in autocratic world happened in countries with only 1 or 2 border countries. If the assumption that countries with more neighbors have more interstate conflicts is true, then autocracy is very likely to have great individual impacts on conflict magnitudes.

It is also noticeable that in "neutral" countries (with a polity2 score of 0) there are also more interstate conflicts compared to its neighboring categories. Since these countries usually have unstable political environment, this finding aligns with the our conclusion from the first graph to some extents.
